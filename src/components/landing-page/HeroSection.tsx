    ...
    <div className="flex flex-col items-center text-center">
     <div className="flex flex-col items-center gap-4 max-w-3xl mx-auto">
      <div className="max-w-[80%] inline-flex items-center rounded-2xl border border-primary/20 bg-secondary backdrop-blur-md px-4 py-1.5 text-sm font-medium text-primary">
       ...
       Creator Plans — Only 20 free spots!
      </div>
      ...
      >
       Save hours of work by automatically repurposing your youtube videos,
       tiktok videos, blog posts, e.t.c into multiple formats for all your
       marketing channels.
      </p>
      <div
      ...
      >
       <div className="flex items-center gap-2 rounded-xl px-4 py-2.5 bg-card/60 backdrop-blur-sm border shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-800/20">
        ...
        <span className="text-sm text-muted-foreground">Youtube Videos</span>
       </div>
       <div className="flex items-center gap-2 rounded-xl px-4 py-2.5 bg-card/60 backdrop-blur-sm border shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-800/20">
       ...
       <div className="flex items-center gap-2 rounded-xl px-4 py-2.5 bg-card/60 backdrop-blur-sm border shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-800/20">
        ...
        <span className="text-sm text-muted-foreground">TikTok Videos</span>
       </div>
       <div className="flex items-center gap-2 rounded-xl px-4 py-2.5 bg-card/60 backdrop-blur-sm border shadow-sm hover:shadow-md transition-all duration-300 hover:border-blue-800/20">
        <Twitter className="h-5 w-5 text-primary" />
        <span className="text-sm text-muted-foreground">Twitter threads</span>
       </div>
      </div>
     </div>
