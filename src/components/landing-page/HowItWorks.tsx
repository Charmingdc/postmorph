...
const HowItWorksHeadline = () => {
  ...
  return (
    <section
      id="how-it-works"
      className="w-[95%] py-16 border-x border-[0.5px] border-y-0 border-border overflow-x-hidden"
    >
      <div
        ref={headerRef}
...
const HowItWorks = () => {
  ...
  return (
    <section className="w-[95%] border-x border-[0.5px] border-y-0 border-border overflow-x-hidden">
...
const HowItWorksButton = () => {
  ...
  return (
    <section className="w-[95%] py-20 border-x border-[0.5px] border-y-0 border-border overflow-x-hidden">
